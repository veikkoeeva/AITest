...
namespace AITest.API
{
    public static class AIApi
    {
        ...
        public static async Task<IResult> HandleChatMessageAsync(ChatMessage chatMessage, IChatCompletionService chatCompletionService, ChatHistory history, CancellationToken cancellationToken)
        {
